    ...
    session_start();
        ...
        { 
            ...
            if(isset($_POST['update']))
            {
                ...
                if($query)
                {
                    $msg="Privacy Page Successfully Updated ";
                }
                else{
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Privacy Page</h2>
                        <ul class="breadcrumb">
